        ...
        public async Task<ActionResult<PostDTO>> GetPost(Guid id)
        {
            ...
            var post = await _context.Posts
                ...
                .Select(post => new PostDTO
                {
                    ...
                    OPName = _context.Users.Where(u => u.Id == post.UserId).Select(u => u.Name).FirstOrDefault(),
                    Following = _context.Followers.Any(f => f.UserId == authenticatedUser.Id && f.FollowedUserId == post.UserId),
                    IsLiked = _context.Likes.Where(l => l.PostId == post.Id && l.UserId == authenticatedUser.Id).FirstOrDefault() != null,
